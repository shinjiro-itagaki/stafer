...
export module SchedulePeriodMap {
  
  class Table extends DB.AbstractTable<Entity> {
    public readonly name: string = "schedule_period_map";
    ...
    public findBy(args: {period_id: string, schedule_id: string}): DB.Record<Entity> | null {
      return this.all().find(function(x: DB.Record<Entity>){ return x.entity.period_id == args.period_id && x.entity.schedule_id == args.schedule_id; }) || null;
    }
